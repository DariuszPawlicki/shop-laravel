                ...
                <DialogContent>
                    <form onSubmit={handleSubmit(onSubmit)} id="new-order-form">
                        <Controller
                            name="series"
                            control={control}
                            defaultValue={order !== null ? order.series : ''}
                            rules={{required: true}}
                        ...
                        <Controller
                            name="name"
                            control={control}
                            defaultValue={order !== null ? order.name : ''}
                            rules={{required: true}}
                            render={({ field }) => <TextField
                                {...field}
                                error={!!errors.name}
                        ...
                        <Controller
                            name="number"
                            control={control}
                            defaultValue={order !== null ? order.number : ''}
                            rules={{required: true}}
                            render={({ field }) => <TextField
                                {...field}
                                error={!!errors.number}
                        ...
                        <Controller
                            name="amount"
                            control={control}
                            defaultValue={order !== null ? order.amount : ''}
                        ...
                        <Controller
                            ...
                            defaultValue={order !== null ? order.order_price : ''}
                            render={({ field }) => <TextField
                                {...field}
                        ...
                        <Controller
                            ...
                            control={control}
                            rules={{required: true, validate: isPositiveFloat}}
                            defaultValue={order !== null ? order.list_price : ''}
                            render={({ field }) => <TextField
                                {...field}
                        ...
                        <Controller
                            ...
                            control={control}
                            defaultValue={order !== null ? order.estimated_price : ''}
                            rules={{required: true, validate: isPositiveFloat}}
                            render={({ field }) => <TextField
                                {...field}
                        ...
                        <Controller
                            name="shop"
                            control={control}
                            defaultValue={order !== null ? order.shop : ''}
                            rules={{required: true}}
                            render={({ field }) => <TextField
                                {...field}
                                error={!!errors.shop}
                        ...
                        <Controller
                            name="order_date"
                            control={control}
                            defaultValue={order !== null ? order.order_date : ''}
                            rules={{required: true}}
                            render={({ field }) => <TextField
                                {...field}
                        ...
                        <Controller
                            name="delivery_date"
                            control={control}
                            defaultValue={order !== null ? order.delivery_date : ''}
                            rules={{required: true}}
                            render={({ field }) => <TextField
                                {...field}
